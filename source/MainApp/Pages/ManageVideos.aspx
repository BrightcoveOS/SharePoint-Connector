    ...
    <div id="mainFormWrapper">
        ...
        <div class="col-md-12 results AllSharepointResults"
            ...
            <ul class="resultItems"
                ...
                <li data-bind="attr: { 'data-order': $index, 'data-name': VideoTitle(), 'data-created': CreatedDate(), 'data-started': VideoStartDate(), 'data-account': Account() }">
                    ...
                    <div class="row">
                        ...
                        <p class="tags" data-bind="foreach: $root.GetTagsArray(Keywords())">
                            <button type="button"
                                ...
                                data-bind="text: $data, attr: { 'class': $root.GetVideoListTagClasses($data, 'btn btn-primary btn-xs') }">
                                Tag 1</button>
                        </p>
                    </div>
                    <div class="row">
        ...
        <div class="col-md-12 search-results-message" id="SearchResultsMessage"></div>
        <!-- ************************************************************************************************** -->
        <!-- End Body Copy -->
        <!-- ************************************************************************************************** -->
