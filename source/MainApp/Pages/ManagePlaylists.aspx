                ...
                <div class="modal-body">
                    ...
                    <div class="manualListControl">
                        <div class="availableVideoSearch">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-btn searchButton">
                                    <a class="btn btn-default searchBtn" data-bind="click: AvailableVideoSearchBtnClick"><i class="glyphicon glyphicon-search"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="availableVideos" data-bind="foreach: FilteredSPVideos">
                            <div class="video" data-bind="attr: { 'data-videoid': VideoID, 'data-referenceid': ReferenceID }, click: AvailableVideoClick">
    ...
    <script type="text/javascript">
        ...
        function addSearchCancel() {
            $('.btnSearchCancel').click(function () {
                ...
                BrightCove.BCApp.Pages.ManagePlayLists.ViewObject().SearchPlayListVideosBtnClick();
            });
        }
        ...
        function AvailableVideoClick(ViewData, Event) {
